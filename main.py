    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEMOTION:
                ...
                if 0 < x - player.get_width()/2 and x + player.get_width()/2 < WIDTH:
                    player.x = x - player.get_height()/2
                if 0 < y - player.get_height()/2 and y + player.get_height()/2 < HEIGHT:
                    player.y = y - player.get_width()/2
